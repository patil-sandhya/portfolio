...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.name && formData.email && formData.phone && formData.message) {
      setFormError(false);
      window.location.href = `mailto:begadesandhya@gmail.com?cc=sandhya2006@gmail.com&subject=${encodeURIComponent(
        formData.subject || "Enquiry"
      )}&body=Hi Sandhya%0D%0A%0D%0AI'm ${encodeURIComponent(
        formData.name
      ...
      <div className="dizme_tm_contact">
        <div className="container">
          <div className="dizme_tm_main_title" data-align="center">
            ...
            <p>
               Feel free to reach out by filling the form below—I’ll be happy to connect.
            </p>
          </div>
